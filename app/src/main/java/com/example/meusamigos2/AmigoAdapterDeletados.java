...
public class AmigoAdapterDeletados extends RecyclerView.Adapter<AmigoHolder> {
    private final List<Amigo> amigos;

    public AmigoAdapterDeletados(List<Amigo> amigos) {
        this.amigos = amigos;
    }
    ...
    public void onBindViewHolder (AmigoHolder holder, int posicao)
    {
        ...
        holder.txvAmigo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                builder.setTitle("Recuperar Amigo")
                        ...
                        .setPositiveButton("Recuperar", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i)
                            {
                                ...
                                boolean ok = dao.recuperarAmigo(amigo.getId(), amigo.getStatus());
